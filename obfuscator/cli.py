...
def generate_obfuscator_key(char_counter, key_name, key_file_path):
    """
...
def main():
    ...
    parser.add_argument("--gen_key", action="store_true", help="Generate obfuscator key")
    ...
    if args.gen_key:
        ...
        generate_obfuscator_key(char_counter, args.key_name, args.key_file)
    elif args.obfuscate:
